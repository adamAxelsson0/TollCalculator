...
{
    public int GetTollFeeForOneDay(Vehicle vehicle, IReadOnlyCollection<DateTime> dates) => GetTollFee(vehicle, dates);
     ...
     */
    public int GetTollFee(Vehicle vehicle, IReadOnlyCollection<DateTime> dates)
    {
